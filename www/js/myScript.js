...
$(document).delegate('#orders', 'pageshow', function () {
                     //alert("Page show");
                    $.mobile.loading( "hide" );
                     });
                  ...
                  $('#submit').click(function() {
                                     ...
                                     $.ajax({
                                           ...
                                           // console.log("XML String:" + xmlString);
                                            ...
                                            var PURL = "http://anica.azurewebsites.net/update.asp?" +"RoleID=" + encodeURIComponent(url_RoleID) + "&ProcID=" +
                                            encodeURIComponent(url_ProcID) + "&DocID=" +encodeURIComponent(url_DocID) + "&UserID=" +
                                            encodeURIComponent(url_UserID) + "&ItemID=" +
                                            encodeURIComponent(url_ItemID) + "&Status=" +
